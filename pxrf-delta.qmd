# pXRF (OLD - Olympus Delta series)

::: callout-note
Last edited: 19DEC2024 NP

Portable X-ray fluorescence (pXRF) is an estimate of elemental composition. This protocol is written for use with an **Olympus Delta series pXRF**. Operating instructions for XRF use in the base, stand, and field are included. **Instructions for the Olympus Vanta series pXRF are in a separate protocol.**
