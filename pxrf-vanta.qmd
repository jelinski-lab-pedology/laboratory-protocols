...
```{r, echo=FALSE, out.width="50%", fig.align="center", fig.cap="Battery port on Vanta pXRF. Line the pins on the battery up with the pins in the unit prior to inserting. The battery will click in when fully inserted."}
...
**Placeholder for two photos for these steps (photos 2 and 3)**
