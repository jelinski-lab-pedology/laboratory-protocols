...
In addition to General Laboratory safety requirements, all pXRF users must complete the following online courses (provided by the UMN Department of Radiation Safety):
...
DEHS RPD: 612-626-6002, dehs@umn.edu
...
3.	Emergency Procedures
	...
	- Suspicion of accidental exposure or overexposure
		- Stop unit usage and notify Dr. Jelinski immediately  – Dr. Jelinski notifies DEHS Radiation Protection – can read user badge if necessary
...
4.	Unit is lost, stolen, or unaccounted for
	- Notify Dr. Jelinski immediately, notify DEHS Radiation Protection
