...
Update 2.0 February 2021

1.	In addition to all general laboratory safety modules, all pXRF users must have completed the 1) Radiation Safety Orientation, 2) Xray and Accelerator Operator Training and 3) Radiation Safety for Radioactive Material Users. These modules can be found at: https://hsrm.umn.edu/health-safety-and-risk-management/training/hsrm-training

2.	All pXRF users must have a currently valid dosimeter, requested from and registered by DEHS. Dosimeters are kept in the drawer labeled pXRF supplies.
